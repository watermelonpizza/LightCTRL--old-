...
namespace LightCTRL
{
    ...
    {        
        ...
        private async void Instance_PanControllerFound(object sender, LifxPanController e)
        {
            ...
            await this.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () => { await StatusBar.GetForCurrentView().ProgressIndicator.HideAsync(); });
        }
        ...
        {
            LifxColor newColour = new LifxColor(){ }
        }
    }
}